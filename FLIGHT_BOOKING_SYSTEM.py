...
mycon=mys.connect(host="localhost",user="root",password="varun2005",database="project")
...
def start():
 ...
 if n==1:
      ...
      print()
      query="select * from flightbook where bcity='{bcity}' and dcity='{dcity}'".format(bcity=a,dcity=b)
      mycursor.execute(query)
      data=mycursor.fetchall()
      nrec=mycursor.rowcount                         
      list1=[]
               ...
               if data!=None:
                    ...
                    if ans3.lower()=="y":
                        ...
                        if n==1:
                                    ...
                                    query=" select flightno,dcity,bcity, jtime, airline from flightbook where flightno=%s"%(fno,)
                                    mycursor.execute(query)
                                    data=mycursor.fetchone()
                                    list4=[]
                                    if data!=None:
